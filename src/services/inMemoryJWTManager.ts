...
const inMemoryJWTManager = () => {
  ...
  // "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwicm9sZSI6ImFkbWluaXN0cmF0b3IiLCJpYXQiOjE2OTA4ODAwOTQsImV4cCI6MTcyMjQzNzY5NH0.l7IGaEy-RQCm9w0KfF0tdbCUBVBdxfJ5CL2VfFNsopE";
  ...
  const ereaseToken = (): boolean => {
    inMemoryJWT = null;
    abordRefreshToken();
    globalThis.localStorage.setItem(logoutEventName, Date.now().toString());
    return true;
  };
