...
exports.createDoka =
    exports.updateDoka =
    exports.propsToElementAttributes =
        undefined;
...
var propsToElementAttributes = (exports.propsToElementAttributes =
    function propsToElementAttributes() {
        var base =
...
var getOptionsFromProps = function getOptionsFromProps(props) {
    return Object.keys(props)
        ...
        .reduce(function (options, key) {
            options[/^on/.test(key) ? key.toLocaleLowerCase() : key] =
                props[key];
            return options;
        }, {});
};
