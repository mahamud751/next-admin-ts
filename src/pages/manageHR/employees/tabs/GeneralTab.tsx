...
const GeneralTab = () => {
  ...
  const [employeeRetirementAction, setEmployeeRetirementAction] = useState("");
      ...
      <SimpleShowLayout>
        <AroggaAccordion title="Employee Primary Data">
          ...
          <ReferenceField
            ...
            label="Designation"
            reference="v1/rank"
            link={({ e_rank_id }) => `/designation-permission/${e_rank_id}`}
          >
        ...
        <AroggaAccordion title="Employee Other Data">
          ...
          <AroggaDateField source="e_date_of_joining" label="Date of Joining" />
          <AroggaDateField
          ...
          <FunctionField
            ...
            render={(record) =>
              employeeConfirmationCheck(record.e_confirmation_date)
                ? "Permanent"
                : "Probation"
            }
          />
          <AroggaDateField source="e_date_of_leaving" label="Date of Leaving" />
          <AroggaDateField
          ...
          <FunctionField
            label="Shift Type"
            render={({ shifts }: Record) => shifts?.[0]?.s_shift_type}
          />
          <FunctionField
            label="Shift Slots"
        ...
        <AroggaAccordion title="Holidays">
          ...
          <FunctionField
            ...
            render={({ holidays }: Record) => {
              ...
              return holidays.map(({ eh_id, eh_holiday_type }) => (
                ...
                <div style={{ marginTop: 8 }}>
                  {e_date_of_leaving === "0000-00-00" && (
                    <Button
                      ...
                      onClick={() => {
                        setEmployeeId(e_id);
                        setEmployeeRetirementAction("terminate");
                  ...
                  {e_date_of_leaving !== "0000-00-00" &&
                    e_date_of_release === "0000-00-00" && (
                      <Button
                        ...
                        onClick={() => {
                          setEmployeeId(e_id);
                          setEmployeeRetirementAction("release");
                          setIsDialogOpen(true);
                        }}
                      />
                    )}
