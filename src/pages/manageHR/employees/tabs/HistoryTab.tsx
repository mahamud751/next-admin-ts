      ...
      {isShowTable && (
        ...
        >
          <Datagrid bulkActionButtons={false}>
            <AroggaDateField source="eh_created_at" label="Created At" />
            <ReferenceField
              label="Created By"
            ...
            <TextField source="eh_reference_table" label="Reference Table" />
            <TextField source="eh_column_name" label="Column Name" />
            <FunctionField
              label="From"
              render={({ eh_column_name }: Record) => {
                if (eh_column_name === "e_rank_id") {
                  ...
                  return <TextField source="eh_old_value" label="From" />;
                }
              }}
            />
            <FunctionField
              ...
              render={({ eh_column_name }: Record) => {
                if (eh_column_name === "e_rank_id") {
                  ...
                  return <TextField source="eh_new_value" label="From" />;
                }
              }}
            />
          </Datagrid>
