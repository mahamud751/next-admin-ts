...
const PolicyList: FC<ListProps> = ({ ...rest }) => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <AroggaDateField source="p_created_at" label="Uploaded Date" />
          <AroggaDateField source="p_effective_date" label="Effective Date" />
          <AroggaDateField source="p_approved_at" label="Approved Date" />
          <AroggaDateField source="p_revised_at" label="Revised Date" />
          <AroggaDateField source="p_created_at" label="Created Date" />
          <ReferenceField
            source="p_created_by"
            label="Created By"
            reference="v1/users"
          ...
          <AroggaDateField source="p_modified_at" label="Modified Date" />
          <ReferenceField
          ...
          <FunctionField
            ...
            render={({ p_id, p_status }: Record) => (
              <Button
                label={p_status === "published" ? "Unpublish" : "Publish"}
                variant="contained"
                onClick={() => {
                  setSelectedPolicyId(p_id);
                  setStatus(
                    p_status === "published" ? "unpublished" : "published"
                  );
